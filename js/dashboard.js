...
function handleEmergency() {
    ...
    if (emergencyContacts.length === 0) {
        alert('Please set up emergency contacts in Settings first.');
        return;
    }
    
    if (confirm('This will share your emergency health information with your designated contacts. Continue?')) {
